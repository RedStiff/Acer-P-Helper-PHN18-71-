...
namespace PredatorControlApp
{
    ...
    public class FanCurveSettingsForm : ResizableBorderlessForm
    {
        ...
        private sealed class FanCurveEditorPanel : Panel
        {
            ...
            public FanCurveEditorPanel(FanCurveConfig config)
            {
                _config = config;
                BackColor = Color.Transparent;
                DoubleBuffered = true;
            ...
            private void BuildUI()
            {
                _graph = new FanCurveGraphControl { Dock = DockStyle.Fill };
